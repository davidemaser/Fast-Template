  ...
  ui:{
    image:function(option,expression,element){
      ...
      imgLoad.bind('load', function () {
        ...
        __WEBPACK_IMPORTED_MODULE_3__components_Faster__["a" /* Architect */].build.experiment($(__WEBPACK_IMPORTED_MODULE_2__config_Global__["a" /* Global */].appRoot).find(`[fstx-id="${element}"]`),null,imageString,true);
      });
    },
    /**
...
/* harmony export (immutable) */ __webpack_exports__["b"] = StylizeUtilities;
...
const Faster = {
  exec(){
    ...
    Architect.render();
    new __WEBPACK_IMPORTED_MODULE_3__classes_RegisterState__["a" /* default */]('app','rendered');
  },
  extract: {
    node: {
      /**
  ...
  remove:{
    emptyTags(){
      $(__WEBPACK_IMPORTED_MODULE_2__config_Global__["a" /* Global */].experiment.node).each(function(){
        let __this = $(this).html().trim();
        __this.length === 0 ? $(this).remove() : null;
      })
    },
    ignoredTags(){
      $(`${__WEBPACK_IMPORTED_MODULE_2__config_Global__["a" /* Global */].experiment.node}[${__WEBPACK_IMPORTED_MODULE_2__config_Global__["a" /* Global */].ignore}]`).each(function(){
        $(this).remove();
      })
    }
  },
    ...
    experiment(origin, replace, content, opt){
      try {
        if (content !== undefined && content !== '') {
          ...
          __WEBPACK_IMPORTED_MODULE_2__config_Global__["a" /* Global */].appStatus !== 'dev' && opt !== true ? $(origin).remove() : null;
        } else {
          __WEBPACK_IMPORTED_MODULE_2__config_Global__["a" /* Global */].appStatus !== 'dev' ? $(origin).remove() : null;
        }
      }catch(e){
          new __WEBPACK_IMPORTED_MODULE_0__classes_Woops__["a" /* default */]({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_classes_FastDom__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_config_Global__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_css_scss_Fast_scss__ = __webpack_require__(73);
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Faster__ = __webpack_require__(7);
...
class FastCycle{
  constructor(type){
    ...
    this.xTag = __WEBPACK_IMPORTED_MODULE_1__config_Global__["a" /* Global */].experiment.node;
    this.xjTag = __WEBPACK_IMPORTED_MODULE_1__config_Global__["a" /* Global */].ajax.node;
    this.nested = __WEBPACK_IMPORTED_MODULE_1__config_Global__["a" /* Global */].experiment.nested;
    this.ignore = __WEBPACK_IMPORTED_MODULE_1__config_Global__["a" /* Global */].ignore;
    this.run();
  }
  run(){
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__FastMath__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__FastDate__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__FastCondition__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__classes_FastAjax__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__FastForm__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__FastGutter__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__classes_FastAnimator__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__FastNav__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__FastAccordion__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__FastTable__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__FastSticky__ = __webpack_require__(62);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__FastBanner__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__FastVideo__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__classes_FastAnalytics__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__classes_FastStylize__ = __webpack_require__(66);
...
class FastAjax{
  ...
  run() {
    new __WEBPACK_IMPORTED_MODULE_1__RegisterState__["a" /* default */]('jsonLoaded',false,'appData');
    ...
    __WEBPACK_IMPORTED_MODULE_0__GetAjax__["a" /* default */](jsonSource, jsonObject, this.element);
  }
}
...
/* harmony export (immutable) */ __webpack_exports__["a"] = TemplateUtilities;
...
const TemplateTableUtilities = {
  elem: 'table.elements',
  template: __WEBPACK_IMPORTED_MODULE_0__config_Template__["a" /* Template */]['table'],
  hold: '',
  init(obj){
...
/* harmony export (immutable) */ __webpack_exports__["a"] = FastAnimatorFunctions;
...
function FastNav(option,expression,element){
  ...
  let objNode = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].nav.node.layout;
  let objNodeEntry = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].nav.node.entry;
  let ajaxUrl = __WEBPACK_IMPORTED_MODULE_0__config_Global__["a" /* Global */].ajax.root.url;
...
function FastTable(option,expression,element){
  ...
  let objCol = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].table.column.layout;
  let objHeader = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].table.header.layout;
  let objFooter = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].table.footer.layout;
  let objBody = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].table.body.layout;
  let ajaxUrl = __WEBPACK_IMPORTED_MODULE_0__config_Global__["a" /* Global */].ajax.root.url;
  if(expression.indexOf('json:')>-1){
    let jsonPath = expression.split('json:')[1].split('}')[0];
    getRemoteJson(`${ajaxUrl}/${jsonPath}.json`);
...
/* harmony default export */ __webpack_exports__["a"] = (function (option,expression) {
  ...
  const util = {
    ...
    buildString:function(){
      ...
      videoLayout = videoLayout.replace('@options',util.buildOptions()).replace('@video.track',util.buildSubTitles()).replace('@id',__WEBPACK_IMPORTED_MODULE_0__config_Template__["a" /* Template */].id.replace('@id',__WEBPACK_IMPORTED_MODULE_1__functions_FastUtilities__["a" /* FastUtilities */].genFtxId()));
      return videoLayout;
    }
  };
...
/* harmony default export */ __webpack_exports__["a"] = (function(option,expression){
  ...
  expArray = __WEBPACK_IMPORTED_MODULE_0__functions_FastUtilities__["a" /* FastUtilities */].array.clean(expArray);
  let linkTemplate = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].linkMap.layout;
  let linkItem = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].linkMap.links.layout;
  let subLinkItem = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].linkMap.subLinks.layout;
  let subLinkHolder = __WEBPACK_IMPORTED_MODULE_1__config_Template__["a" /* Template */].linkMap.subLinks.holder;
  let linkString = '';
  expArray.map((a)=>{
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js??ref--1-2!./Fast.scss", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/lib/loader.js??ref--1-2!./Fast.scss");
...
// module
exports.push([module.i, "body[faster=\"template\"]{display:none}body[faster=\"rendered\"]{display:block;margin:0}ftx{display:none}fta{display:none}.ftx__modal{display:none;position:absolute;top:0;left:0;width:100%;height:100%}.ftx__modal__overlay{position:absolute;width:100%;height:100%;background:rgba(0,0,0,0.5);top:0;left:0}.ftx__modal__inlay{position:absolute;width:50%;left:25%;right:25%;top:25%;bottom:25%;background:#fff;z-index:999}.ftx__modal__title,.ftx__modal__message,.ftx__modal__prompt{padding:20px}.ftx__modal__prompt{position:absolute;bottom:0;right:0}nav.ftx__nav_horizontal{display:block;padding:5px;position:relative}div[ftx-role=\"nav-parent\"]{display:inline-block}div[ftx-role=\"nav-parent\"] .ftx__nav_dropdown{display:none;position:absolute}div[ftx-role=\"nav-parent\"]:hover .ftx__nav_dropdown{display:block}.ftx__accordion{display:block}.ftx__accordion .item__title{background:#ddd;padding:5px;cursor:pointer}.ftx__accordion .item__body{padding:10px 5px}.accordion_item{display:block;border-left:solid 1px #000;border-right:solid 1px #000;border-top:solid 1px #000}.accordion_item:last-child{border-bottom:1px solid #000}.accordion_item:not(:first-child) .item__body{display:none}header{padding:10px;position:relative;width:100%;height:auto}header.clone{position:fixed;top:-65px;left:0;right:0;z-index:999;transition:0.2s top cubic-bezier(0.3, 0.73, 0.3, 0.74)}header.ftx__sticky{background:#fff}header.ftx__sticky.top{position:absolute;top:0}body.down header.clone{top:0;background:#fff}.ftx__placeholder{display:block;width:100%;clear:both}.ftx__placeholder.small{height:10px}.ftx__placeholder.large{height:100px}.ftx__placeholder.medium{height:50px}.ftx__banner{overflow:hidden;position:relative}.ftx__banner h1{text-transform:uppercase}.ftx__banner h1,.ftx__banner p{width:100%;text-align:center}.ftx__banner.full{width:100%;height:500px}.ftx__banner.full>div{width:100%;height:100%}.ftx__banner.container{padding:5px 0}.ftx__banner.container>*{margin:5px 10px}.ftx__banner_row{text-align:center}div[ftx-sub-group] div[ftx-sub-item]{display:inline-block;cursor:pointer}div[ftx-sub-group] div[ftx-sub-item]:not(:first-child):before{content:\">\";padding:0 5px}\n", ""]);
