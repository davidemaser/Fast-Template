...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config_Global__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__classes_Errors__ = __webpack_require__(1);
/**
 * Created by David Maser on 19/06/2017.
 */
  ...
  cycle(){
    ...
    domNodes.map((a,b)=>{
      ...
      if(a.indexOf('render:') > -1){
        nodeType = __WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["b" /* DomCleaner */].extract.node.type(a);
        nodeString = `<${nodeType} class="${__WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["b" /* DomCleaner */].extract.class(a)}">`;
      }else{
        if(a.indexOf('template:') > -1 ){
          nodeString = __WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["b" /* DomCleaner */].extract.template(a);
        }else{
      ...
      nodeString += __WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["b" /* DomCleaner */].extract.content(a) !== undefined ? `${__WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["b" /* DomCleaner */].extract.content(a)}</${nodeType}>` : null;
      let nodeElement = $('body').find(`[fst-id="${b}"]`);
      console.log(nodeType,__WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["b" /* DomCleaner */].extract.class(a),__WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["b" /* DomCleaner */].extract.content(a));
      __WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["a" /* DomBuilder */].build.element(nodeElement,nodeString,__WEBPACK_IMPORTED_MODULE_0__components_DomCleaner__["b" /* DomCleaner */].extract.content(a));
    })
  }
}
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_Errors__ = __webpack_require__(1);
...
/* harmony export (immutable) */ __webpack_exports__["b"] = DomCleaner;
...
/* harmony export (immutable) */ __webpack_exports__["a"] = DomBuilder;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__config_Global__ = __webpack_require__(2);
/**
 * Created by David Maser on 19/06/2017.
 */
